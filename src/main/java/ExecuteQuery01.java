...
public class ExecuteQuery01 {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        Connection con =DriverManager.getConnection("jdbc:postgresql://localhost:5432/jdbcnt_db","techpront","password");//connection ile database ile iletişimi sağlanıyor
...
//            names.add(resultSet.getString("country_name"));
        ...
        while (rs.next()){
            ...
            System.out.println("Tel kodu: "+rs.getInt("phone_code")+"--Ülke ismi: "+rs.getString("country_name"));
