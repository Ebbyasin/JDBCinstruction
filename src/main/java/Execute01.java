...
public class Execute01 {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        //3.ADIM:Statement nesnesini oluşturma:SQL sorgularını DB ve çalıştırma için
        ...
        //DQL için kullanılarsa:ResultSet nesnesi alırsa TRUE değerini döndürür.
        ...
        //5.ADIM:bağlantıyı ve statement ı kapatma
        st.close();
        connection.close();
    }
}
